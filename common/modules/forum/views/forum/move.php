...
$this->title = Yii::t('view', 'Move Thread');
        ...
        <div class="panel panel-default">
            <?= Html::beginForm(); ?>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <?= Html::label(Yii::t('view', 'Select a forum for this thread to be moved to'), 'forum') ?>
                ...
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-sm-12">
                            <?= Html::submitButton('<span class="glyphicon glyphicon-ok-sign"></span> ' . Yii::t('view', 'Move Thread'), ['class' => 'btn btn-block btn-primary', 'name' => 'save-button']) ?>
                        </div>
                    </div>
                </div>
            <?= Html::endForm(); ?>
