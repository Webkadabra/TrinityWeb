...
$this->title = Yii::t('view', 'Unread posts');
...
<div class="row">
    <div class="col-sm-12 text-right">
        <ul class="list-inline">
            <li><a href="<?= Url::to(['forum/mark-seen']) ?>" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-eye-open"></span> <?= Yii::t('view', 'Mark all as seen') ?></a></li>
        </ul>
    </div>
</div>
<div class="panel panel-default">
    <div class="panel-heading" role="tab" id="unreadThreads">
        <h4 class="panel-title"><?= Yii::t('view', 'Unread posts') ?></h4>
    </div>
    <div id="collapseUnread" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="unreadThreads">
        <table class="table table-hover">
            ...
            <?= ListView::widget([
                ...
                'summary'          => '',
                'emptyText'        => Yii::t('view', 'No more unread posts at the moment.'),
