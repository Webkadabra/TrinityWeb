...
class LanguageTranslate extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['id'], 'integer'],
            [['id'], 'exist', 'targetClass' => '\common\modules\i18n\models\LanguageSource'],
            [['language'], 'exist', 'targetClass' => '\common\modules\i18n\models\Language', 'targetAttribute' => 'language_id'],
            [['translation'], 'string'],
