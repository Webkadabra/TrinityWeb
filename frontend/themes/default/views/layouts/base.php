...
?>
<div id="wrap">
    <nav id="header-nav" class="navbar navbar-expand-md fixed-top default-tw-nav">
        <div class="container">
            <?=Html::a(Yii::$app->settings->get(Yii::$app->settings::APP_NAME) ? Yii::$app->settings->get(Yii::$app->settings::APP_NAME) : Yii::$app->name,['/main/index'],[
