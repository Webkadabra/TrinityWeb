 ...
 *
 * @property array $phpMomentMappings
 */
class DateTimeWidget extends InputWidget
{
    ...
    protected function renderInputAddon()
    {
        ...
        if (!array_key_exists('class', $this->inputAddonOptions)) {
            Html::addCssClass($this->inputAddonOptions, 'input-group-addon align-self-center ml-2');
        }
        ...
        if ($this->inputAddonContent) {
            ...
            $content[] = Html::tag('span', '', ['class' => 'fa fa-calendar']);
        }
