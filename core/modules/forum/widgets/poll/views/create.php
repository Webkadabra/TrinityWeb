...
?>
<button class="btn btn-success podium-poll-add <?= $model->pollAdded ? 'd-none' : '' ?>">
    <span class="glyphicon glyphicon-tasks"></span> <?= Yii::t('podium/view', 'Add poll to this thread'); ?>
</button>

<div class="new-poll <?= $model->pollAdded ? '' : 'd-none' ?>">
    <div class="panel panel-default">
        <div class="panel-heading">
            <button class="btn btn-xs btn-danger float-right podium-poll-discard"><span class="glyphicon glyphicon-remove"></span> <?= Yii::t('podium/view', 'Discard poll'); ?></button>
