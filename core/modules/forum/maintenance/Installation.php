...
namespace core\modules\forum\maintenance;
    ...
    protected function addConfig()
    {
        try {
            $this->db->createCommand()->batchInsert(
                    ...
                    ['key', 'value'],
                    [
                        ['forum.allow_polls', PodiumConfig::FLAG_ALLOW_POLLS],
                        ['forum.from_name', PodiumConfig::DEFAULT_FROM_NAME],
                        ['forum.hot_minimum', PodiumConfig::HOT_MINIMUM],
                        ['forum.maintenance_mode', PodiumConfig::MAINTENANCE_MODE],
                        ['forum.max_attempts', PodiumConfig::MAX_SEND_ATTEMPTS],
                        ['forum.members_visible', PodiumConfig::FLAG_MEMBERS_VISIBLE],
                        ['forum.merge_posts', PodiumConfig::FLAG_MERGE_POSTS],
                        ['forum.meta_description', PodiumConfig::META_DESCRIPTION],
                        ['forum.meta_keywords', PodiumConfig::META_KEYWORDS],
                        ['forum.name', PodiumConfig::PODIUM_NAME],
                        ['forum.use_wysiwyg', PodiumConfig::FLAG_USE_WYSIWYG],
