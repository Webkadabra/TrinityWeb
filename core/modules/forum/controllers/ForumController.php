...
use core\modules\forum\models\forms\SearchForm;
...
use core\modules\forum\models\Vocabulary;
    ...
    public function behaviors()
    {
        return [
            'access' => [
                ...
                'ruleConfig' => ['class' => 'core\modules\forum\filters\LoginRequiredRule'],
                'rules'      => [
                    ...
                    [
                        'class' => 'core\modules\forum\filters\PodiumRoleRule',
                        'allow' => true
                    ],
                ],
            ],
