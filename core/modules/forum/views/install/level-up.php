...
<?php if ($error === '' && $info === ''): ?>
        <div class="form-group">
            <em><?php echo Yii::t('podium/view', 'Podium will attempt to update all database tables to the current version.'); ?></em><br>
            <em><strong class="text-danger"><?php echo Yii::t('podium/view', 'Back up your existing database and then click the button below.'); ?></strong></em>
        </div>
        ...
        <div class="form-group">
            <button id="installPodium" class="btn btn-warning btn-lg"><span class="glyphicon glyphicon-open"></span> <?php echo Yii::t('podium/view', 'Upgrade Podium Database'); ?></button>
        </div>
<?php elseif ($error !== ''): ?>
...
<?php endif; ?>
        <div class="form-group">
            <?php echo Yii::t('podium/view', 'Current database version'); ?> <kbd><?php echo $dbVersion; ?></kbd> <span class="glyphicon glyphicon-transfer"></span> <kbd><?php echo $currentVersion; ?></kbd> <?php echo Yii::t('podium/view', 'Current module version'); ?>
        </div>
<?php if ($info === ''): ?>
...
<div class="row d-none" id="installationResults">
    ...
    <div class="col-sm-8 col-sm-offset-2 d-none" id="installationError">
        <div class="alert alert-danger" role="alert"><?php echo Yii::t('podium/view', 'There was a major error during update...'); ?></div>
    </div>
    <div class="row d-none" id="installationFinished">
        <div class="text-center col-sm-12">
            <a href="<?php echo Url::to(['forum/index']); ?>" class="btn btn-success btn-lg"><span class="glyphicon glyphicon-ok-sign"></span> <?php echo Yii::t('podium/view', 'Update finished'); ?></a>
        </div>
    </div>
    <div class="row d-none" id="installationFinishedError">
        <div class="text-center col-sm-12">
            <button class="btn btn-danger btn-lg"><span class="glyphicon glyphicon-alert"></span> <?php echo Yii::t('podium/view', 'Errors during update'); ?></button>
        </div>
    </div><br>
