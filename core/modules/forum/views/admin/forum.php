        ...
        <ul class="nav navbar-nav">
            <li role="presentation" class="nav-item">
                <a href="<?= Url::to(['admin/categories']) ?>" class="nav-link">
                    <span class="glyphicon glyphicon-list"></span> <?= Yii::t('view', 'Categories List') ?>
                </a>
            </li>
            <?php foreach ($categories as $category): ?>
                <li role="presentation" class="nav-item">
                    <a href="<?= Url::to(['admin/new-forum', 'cid' => $category->id]) ?>" class="nav-link">
                        <span class="glyphicon glyphicon-chevron-right"></span> <?= Html::encode($category->name) ?>
                    </a>
                </li>
            <?php endforeach; ?>
            <li role="presentation" class="nav-item">
                <a href="<?= Url::to(['admin/new-category']) ?>" class="nav-link">
                    <span class="glyphicon glyphicon-plus"></span> <?= Yii::t('view', 'Create new category') ?>
                </a>
            </li>
        </ul>
    </div>
