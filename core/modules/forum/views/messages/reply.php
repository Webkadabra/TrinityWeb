                ...
                <div class="col-sm-10">
                    <div class="popover right podium">
                        ...
                        <div class="popover-title">
                            <small class="float-right"><span data-toggle="tooltip" data-placement="top" title="<?= Podium::getInstance()->formatter->asDatetime($reply->created_at, 'long') ?>"><?= Podium::getInstance()->formatter->asRelativeTime($reply->created_at) ?></span></small>
