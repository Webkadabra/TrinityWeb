...
<div class="row">
    <div class="col-md-3 col-sm-4">
        <?php echo $this->render('/elements/profile/_navbar', ['active' => 'details']); ?>
    </div>
        ...
        <div class="panel panel-default">
            <?php $form = ActiveForm::begin(['id' => 'details-form']); ?>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <?php echo $form->field($model, 'username')->textInput(array_merge([
                                'data-container' => 'body',
                                'data-toggle'    => 'popover',
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <button class="btn btn-warning btn-block <?php echo !empty($model->new_email) ? 'd-none' : ''; ?>" id="show-email"><span class="glyphicon glyphicon-envelope"></span> <?php echo Yii::t('podium/view', 'Change e-mail address'); ?></button>
                            </div>
                        </div>
<?php if (Podium::getInstance()->userComponent === true): ?>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <button class="btn btn-warning btn-block <?php echo !empty($model->newPassword) ? 'd-none' : ''; ?>" id="show-password"><span class="glyphicon glyphicon-lock"></span> <?php echo Yii::t('podium/view', 'Change password'); ?></button>
                            </div>
                        </div>
<?php endif; ?>
                    </div>
                    <div class="row <?php echo empty($model->new_email) ? 'd-none' : ''; ?>" id="details-email">
                        <div class="col-sm-12">
                            <?php echo $form->field($model, 'new_email')->textInput([
...
<?php if (Podium::getInstance()->userComponent === true): ?>
                    <div id="details-password" class="<?php echo empty($model->newPassword) ? 'd-none' : ''; ?>">
                        <div class="row">
                            <div class="col-sm-12">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <?php echo $form->field($model, 'newPasswordRepeat')->passwordInput([
                                        'autocomplete' => 'off',
                                        'placeholder'  => Yii::t('podium/view', "Leave empty if you don't want to change it"),
                                        'disabled'     => empty($model->newPassword) ? true : false
...
<?php endif; ?>
                ...
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-sm-12">
                            <?php echo $form->field($model, 'currentPassword')->passwordInput(['autocomplete' => 'off'])->label(Yii::t('podium/view', 'Current password')); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
