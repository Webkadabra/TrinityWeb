    ...
    <div class="col-sm-10">
        <div class="popover right podium">
            ...
            <div class="popover-title">
                <small class="float-right"><span data-toggle="tooltip" data-placement="bottom" title="<?= Yii::t('podium/view', 'As soon as you click Post Reply') ?>"><?= Yii::t('podium/view', 'In a while') ?></span></small>
                <?= $author->podiumTag ?>
            </div>
