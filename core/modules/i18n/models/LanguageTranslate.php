...
namespace core\modules\i18n\models;
...
class LanguageTranslate extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['id'], 'integer'],
            [['id'], 'exist', 'targetClass' => '\core\modules\i18n\models\LanguageSource'],
            [['language'], 'exist', 'targetClass' => '\core\modules\i18n\models\Language', 'targetAttribute' => 'language_id'],
            [['translation'], 'string'],
