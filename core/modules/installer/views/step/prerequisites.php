...
<div class="card card-default">
    <div class="card-header">
        <h2 class="text-center">
            <?php echo Yii::t('installer','System Check');?>
        </h2>
    </div>
    <div class="card-body">
            <p><?php echo Yii::t('installer','In the following overview, you can see, if all the requirements are ready.');?></p>
            <hr/>
            ...
            <?php if (!$hasError) { ?>
                <div class="alert alert-success">
                    <?php echo Yii::t('installer','Congratulations! Everything is ok and ready to start over!');?>
                </div>
            <?php
            } ?>
            <hr/>
            ...
            <div class="row no-gutters justify-content-between">
                <div class="col-auto">
                    <?php echo \yii\helpers\Html::a('<i class="fas fa-redo"></i> ' . Yii::t('installer','Check again'), ['prerequisites'], ['class' => 'btn btn-info']); ?>
                </div>
                <div class="col-auto">
                    <?php if (!$hasError) { ?>
                        <?php
                        ...
                        ?>
                        <?php echo \yii\helpers\Html::submitButton(Yii::t('installer','Next') . ' <i class="fa fa-arrow-circle-right"></i>', ['class' => 'btn btn-primary']); ?>
                        <?php
                        $form::end();
                        ?>
                    <?php } ?>
