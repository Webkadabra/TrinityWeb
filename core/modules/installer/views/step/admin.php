...
<div id="card-form" class="card card-default">
    <div class="card-header">
        <h2 class="text-center">
            <?php echo Yii::t('installer','Creating administrator account');?>
        </h2>
    </div>
    <div class="card-body">

        <p><?php echo Yii::t('installer','You\'re almost done. In the last step you have to fill out the form to create an admin account. With this account you can manage the whole website.');?></p>
        ...
        ?>
            ...
            <div class="text-center">
                <?php echo \yii\helpers\Html::submitButton(Yii::t('installer','Create Admin Account'), ['class' => 'btn btn-primary']); ?>
            </div>
        <?php ActiveForm::end(); ?>
    </div>
</div>