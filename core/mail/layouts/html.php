...
<head>
    ...
    <style>
        ...
        .trinityweb-black {color: #333;}
        .trinityweb-white {color: #C5C0C0;}
        .trinityweb-orange {color: #e84d3b;}
        .trinityweb-green {color: #5cb85c;}
        .trinityweb-aqua {color: #36BBA6;}
        .trinityweb-999 {color: #999;}
