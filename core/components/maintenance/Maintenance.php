...
class Maintenance extends Component implements BootstrapInterface
{
     ...
     * @var string
     */
    public $maintenanceLayout = '@core/components/maintenance/views/layouts/main.php';
    /**
     * @var string
     */
    public $maintenanceView = '@core/components/maintenance/views/maintenance/index.php';
    /**
     * @var string
     */
